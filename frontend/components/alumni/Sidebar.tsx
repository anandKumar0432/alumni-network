...
import { Users, UserCheck, GraduationCap, MessageSquareShare, Contact, Menu, Dot, X } from "lucide-react";
...
const nav = [
  ...
  { name: "Share Referral", href: "/referral", icon: MessageSquareShare },
  { name: "Contact tpo", href: "/contact", icon: Contact },
  { name: "Edit Profile", href: "/edit_profile", icon: Dot },
];
      ...
      >
        <div className="h-14 px-4 flex items-center justify-between border-b">
          <div className="flex items-center gap-2 font-bold text-lg">
            ...
            {!collapsed && <span>KEC Alumni</span>}
          </div>
        ...
        <div className="p-3 border-t text-xs text-gray-500">
          {!collapsed && "KEC Connect Alumni Panel"}
        </div>
      </aside>
    </>
  );
